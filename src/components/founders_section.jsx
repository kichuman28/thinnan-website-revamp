...
const FoundersSection = () => {
    ...
    >
      ...
      <div className="relative w-full max-w-[280px] mx-auto rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500" style={{ aspectRatio: '1 / 1' }}>
        ...
        <a 
          ...
          className="absolute top-4 right-4 bg-white rounded-full p-2 shadow-lg hover:bg-accent hover:text-white transition-all duration-300 z-10 transform hover:scale-110"
        >
      ...
      {/* Text Content */}
      <div className="mt-5 space-y-2 max-w-[280px] mx-auto text-center transform transition-transform duration-300 group-hover:translate-y-[-4px]">
        <h3 className="text-2xl font-semibold text-black capitalize relative inline-block">
          {member.name}
  ...
  return (
    <section id="team" className="py-20 sm:py-28 md:py-36 relative overflow-hidden bg-white">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden transition-all duration-500">
            ...
            >
              ...
              >
                <svg className="w-6 h-6 sm:w-7 sm:h-7 text-gray-600 group-hover:text-accent transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div 
              ...
              style={{
                maxHeight: openSections.founders ? '1000px' : '0px',
