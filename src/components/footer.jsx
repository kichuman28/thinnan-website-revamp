          ...
          <div className="col-span-2 sm:col-span-2 mb-6 sm:mb-0">
            <div className="flex items-start gap-4 sm:gap-6 mb-4 sm:mb-6">
              ...
              <div className="flex-shrink-0">
                <div className="bg-black rounded-2xl sm:rounded-3xl p-4 sm:p-5 w-24 h-24 sm:w-32 sm:h-32 md:w-36 md:h-36 flex items-center justify-center">
                  <img 
                    src={appIcon} 
                    alt="thinnan" 
              ...
              <div className="flex-1 flex flex-col justify-start space-y-1 sm:space-y-2">
                <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-primary-text leading-tight">
                  thinnan
                </h3>
                ...
                <p className="text-xs sm:text-sm text-gray-500 font-normal mt-1 sm:mt-2">
                  origin: malayalam language
                </p>
              </div>
            </div>
            
            {/* Social Media Links - Evenly Spaced */}
